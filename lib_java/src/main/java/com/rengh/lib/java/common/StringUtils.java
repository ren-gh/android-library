...
public class StringUtils {
    ...
    public static String getXmlValue(String content, String key) {
        return getXmlValue(content, key, null);
    }

    public static String getXmlValue(String content, String key, String def) {
        if (isEmpty(content)) {
            return null;
        }
        String value = null;
