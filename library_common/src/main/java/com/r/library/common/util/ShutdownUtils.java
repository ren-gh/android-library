...
public class ShutdownUtils {
    ...
    public static void shutdown(Context context, ShutdownListener listener) {
        ...
        try {
            ...
            try {
                ...
                LogUtils.d(TAG, "shutdown() Success");
            } catch (Exception e) {
                // 获得shutdown()方法
            ...
            LogUtils.e(TAG, "shutdown() Exception: " + e.getMessage());
            if (null != listener) {
                listener.onFailed();
            }
        }
    ...
    public static void goToSleep(Context context, ShutdownListener listener) {
        LogUtils.d(TAG, "goToSleep() Start...");
        try {
            // 获得ServiceManager类
            Class ServiceManager = Class.forName("android.os.ServiceManager");
            // 获得ServiceManager的getService方法
            ...
            LogUtils.d(TAG, "goToSleep() Success");
        } catch (Exception e) {
            LogUtils.e(TAG, "goToSleep() Exception: " + e.getMessage());
            if (null != listener) {
                listener.onFailed();
            }
        }
