...
public class PlayerView2 extends RelativeLayout implements WeakHandlerListener {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        LayoutInflater.from(mContext).inflate(R.layout.view_player2, this);
        LogUtils.i(TAG, "init()");
    ...
    private void initValues() {
        ...
        if (null != params) {
            ...
            mVideoName = params.getVideoTile();
            mPlayerListener = params.getPlayerListener();
            mDoubleClick = params.getDoubleClick();
    ...
    private void playVideo() {
        if (!mMediaPlayer.isPlaying()) {
            ...
            if (TextUtils.isEmpty(mVideoName)) {
                ...
                ToastUtils.showToast(mContext, mContext.getString(R.string.player_toast_playing_with_name, mVideoName));
            }
        }
    }
